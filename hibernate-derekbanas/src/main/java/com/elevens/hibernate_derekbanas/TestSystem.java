package com.elevens.hibernate_derekbanas;
...
public class TestSystem {
	...
	private static final EntityManagerFactory ENTITY_MANAGER_FACTORY = Persistence.createEntityManagerFactory("hibernate-derekbanas");
